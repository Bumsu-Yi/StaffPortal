...
from .views import EmployeeDetail, JobHistoryList, DepartmentWithLocationList, SalaryIncreaseAPIView, UVIndexAPIView
...
urlpatterns = [
    ...
    path('uv-index/<int:area_no>/', UVIndexAPIView.as_view(), name='uv-index'),
]
