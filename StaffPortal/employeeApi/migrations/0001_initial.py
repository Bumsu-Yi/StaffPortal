# Generated by Django 4.2.7 on 2024-04-02 18:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_salary', models.DecimalField(blank=True, decimal_places=0, max_digits=8, null=True)),
                ('max_salary', models.DecimalField(blank=True, decimal_places=0, max_digits=8, null=True)),
            ],
            options={
                'db_table': 'jobs',
                'managed': False,
